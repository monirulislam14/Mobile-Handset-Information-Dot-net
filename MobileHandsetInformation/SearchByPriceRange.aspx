<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchByPriceRange.aspx.cs" Inherits="MobileHandsetInformation.SearchByPriceRange" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 100%;">
        <tr>
            <td colspan="2"><strong>Search BY Price Range</strong></td>
        ...
        <tr>
            <td class="modal-sm" style="width: 100px">Price Between</td>
            <td style="width: 152px">
                <asp:TextBox ID="TextBox1" runat="server" Width="142px"></asp:TextBox>
            </td>
            <td style="width: 37px">And</td>
